TARGET = ladybug
OBJ1 = FuncTools.o
OBJ2 = symbol_table.o mem.o ir.o err_buff.o expressions.o expr_toolbox.o ir_toolbox.o main_app.o subprograms.o scope.o bitmap.o ir_printer.o reg.o statements.o
OBJ = $(OBJ1) $(OBJ2)
OBJ_LEX = lex.yy.o
