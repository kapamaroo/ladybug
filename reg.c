...
reg_t R_lo = {.is = REG_ACC,           .r = 0, .name = "$lo",   .alias = "acc0" };
reg_t R_hi = {.is = REG_ACC,           .r = 1, .name = "$hi",   .alias = "acc1" };

reg_t FP_0 = {.is = REG_FLOAT,         .r = 0, .name = "$f0",   .alias = "fp0" };
reg_t FP_1 = {.is = REG_FLOAT,         .r = 1, .name = "$f1",   .alias = "fp1" };
reg_t FP_2 = {.is = REG_FLOAT,         .r = 2, .name = "$f2",   .alias = "fp2" };
reg_t FP_3 = {.is = REG_FLOAT,         .r = 3, .name = "$f3",   .alias = "fp3" };
reg_t FP_4 = {.is = REG_FLOAT,         .r = 4, .name = "$f4",   .alias = "fp4" };
reg_t FP_5 = {.is = REG_FLOAT,         .r = 5, .name = "$f5",   .alias = "fp5" };
reg_t FP_6 = {.is = REG_FLOAT,         .r = 6, .name = "$f6",   .alias = "fp6" };
reg_t FP_7 = {.is = REG_FLOAT,         .r = 7, .name = "$f7",   .alias = "fp7" };
reg_t FP_8 = {.is = REG_FLOAT,         .r = 8, .name = "$f8",   .alias = "fp8" };
reg_t FP_9 = {.is = REG_FLOAT,         .r = 9, .name = "$f9",   .alias = "fp9" };
reg_t FP_10 = {.is = REG_FLOAT,        .r = 10, .name = "$f10",   .alias = "fp10" };
reg_t FP_11 = {.is = REG_FLOAT,        .r = 11, .name = "$f11",   .alias = "fp11" };
reg_t FP_12 = {.is = REG_FLOAT,        .r = 12, .name = "$f12",   .alias = "fp12" };
reg_t FP_13 = {.is = REG_FLOAT,        .r = 13, .name = "$f13",   .alias = "fp13" };
reg_t FP_14 = {.is = REG_FLOAT,        .r = 14, .name = "$f14",   .alias = "fp14" };
reg_t FP_15 = {.is = REG_FLOAT,        .r = 15, .name = "$f15",   .alias = "fp15" };
reg_t FP_16 = {.is = REG_FLOAT,        .r = 16, .name = "$f16",   .alias = "fp16" };
reg_t FP_17 = {.is = REG_FLOAT,        .r = 17, .name = "$f17",   .alias = "fp17" };
reg_t FP_18 = {.is = REG_FLOAT,        .r = 18, .name = "$f18",   .alias = "fp18" };
reg_t FP_19 = {.is = REG_FLOAT,        .r = 19, .name = "$f19",   .alias = "fp19" };
reg_t FP_20 = {.is = REG_FLOAT,        .r = 20, .name = "$f20",   .alias = "fp20" };
reg_t FP_21 = {.is = REG_FLOAT,        .r = 21, .name = "$f21",   .alias = "fp21" };
reg_t FP_22 = {.is = REG_FLOAT,        .r = 22, .name = "$f22",   .alias = "fp22" };
reg_t FP_23 = {.is = REG_FLOAT,        .r = 23, .name = "$f23",   .alias = "fp23" };
reg_t FP_24 = {.is = REG_FLOAT,        .r = 24, .name = "$f24",   .alias = "fp24" };
reg_t FP_25 = {.is = REG_FLOAT,        .r = 25, .name = "$f25",   .alias = "fp25" };
reg_t FP_26 = {.is = REG_FLOAT,        .r = 26, .name = "$f26",   .alias = "fp26" };
reg_t FP_27 = {.is = REG_FLOAT,        .r = 27, .name = "$f27",   .alias = "fp27" };
reg_t FP_28 = {.is = REG_FLOAT,        .r = 28, .name = "$f28",   .alias = "fp28" };
reg_t FP_29 = {.is = REG_FLOAT,        .r = 29, .name = "$f29",   .alias = "fp29" };
reg_t FP_30 = {.is = REG_FLOAT,        .r = 30, .name = "$f30",   .alias = "fp30" };
reg_t FP_31 = {.is = REG_FLOAT,        .r = 31, .name = "$f31",   .alias = "fp31" };
